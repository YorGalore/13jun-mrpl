...
# Fallback Virtuoso lokal (cadangan saat SEPSES publik gagal / belum punya datanya)
SPARQL_LOCAL_ENDPOINT = _clean(os.getenv("SEPSES_LOCAL_ENDPOINT")) or "http://localhost:8890/sparql"
SPARQL_LOCAL_GRAPH = _clean(os.getenv("SEPSES_LOCAL_GRAPH")) or "http://sepses.local"
SPARQL_ENABLE_LOCAL_FALLBACK = _bool("SEPSES_ENABLE_LOCAL_FALLBACK", True)
