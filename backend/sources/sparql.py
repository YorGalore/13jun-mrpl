...
# =====================================================================
# CORE — eksekutor SPARQL tunggal (selalu publik, tidak pernah raise)
# =====================================================================
def _wrapper() -> SPARQLWrapper:
    w = SPARQLWrapper(SPARQL_PUBLIC_ENDPOINT)
...
def run_query(query: str) -> List[Dict[str, str]]:
    """Jalankan SPARQL ke endpoint publik; kembalikan list-of-dict. [] bila gagal."""
    try:
        w = _wrapper()
        w.setQuery(query)
